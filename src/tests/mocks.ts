...
export const mockData = {
  count: 5457,
  imageIntro: 'https://agenciadenoticias.ibge.gov.br/images/agenciadenoticias/estatisticas_economicas/2023_10/pmc-set-thumb-alerrandre-barros.jpg',
  page: 1,
  totalPages: 546,
  nextPage: 2,
  previousPage: 0,
